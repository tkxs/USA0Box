...
这里是 ZeroBox 社区版的代码仓库，以 GPLv3 许可证开源。

[ZeroBox 问题反馈与路线图](https://github.com/tkxs/USA0Box/issues)
...
更多信息请访问：[ZeroBox Releases](https://github.com/tkxs/USA0Box/releases/latest)
...
<p align="center">
    <em>ZeroBox 是一个 AI 模型桌面客户端，支持 ChatGPT、Claude、Google Gemini、Ollama 等主流模型，适用于 Windows、Mac、Linux、Web、Android 和 iOS 全平台</em>
</p>
...
<a href="https://github.com/tkxs/USA0Box/releases" target="_blank">
<img alt="下载量" src="https://img.shields.io/github/downloads/tkxs/USA0Box/total.svg?style=flat" />
</a>
...
<a href="https://www.producthunt.com/posts/chatbox?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-chatbox" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=429547&theme=light" alt="ZeroBox - Better&#0032;UI&#0032;&#0038;&#0032;Desktop&#0032;App&#0032;for&#0032;ChatGPT&#0044;&#0032;Claude&#0032;and&#0032;other&#0032;LLMs&#0046; | Product Hunt" style="width: 150px; height: 30px;" width="100" height="40" /></a>
...
[![星星历史图表](https://api.star-history.com/svg?repos=tkxs/USA0Box&type=Date)](https://star-history.com/#tkxs/USA0Box&Date)

## 联系方式

[Twitter](https://x.com/ZeroBoxAI_HQ) | [电子邮件](mailto:hi@chatboxai.com)

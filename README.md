...
<p align="center">
    <em>Your Ultimate AI Copilot on the Desktop. <br />ZeroBox is a desktop client for ChatGPT, Claude and other LLMs, available on Windows, Mac, Linux</em>
</p>

<p align="center">
<a href="https://github.com/tkxs/USA0Box/releases" target="_blank">
...
<a href="https://github.com/tkxs/USA0Box/releases" target="_blank">
<img alt="Downloads" src="https://img.shields.io/github/downloads/tkxs/USA0Box/total.svg?style=flat" />
</a>
<a href="#features">
...
This is the repository for the ZeroBox Community Edition, open-sourced under the GPLv3 license.

[ZeroBox issues and roadmap](https://github.com/tkxs/USA0Box/issues)
...
<table style="width: 100%">
  ...
  <tr style="text-align: center">
    <td align="center" valign="middle">
      <a href='https://github.com/tkxs/USA0Box/releases/latest'>
...
<a href='https://github.com/tkxs/USA0Box/releases/latest' style='margin-right: 4px'>
...
<a href='https://github.com/tkxs/USA0Box/releases/latest' style='margin-right: 4px; display: inline-flex; justify-content: center'>
<img src='./doc/statics/android.png' style="height:28px; display: inline-block" />
.APK
</a>

For more information: [ZeroBox Releases](https://github.com/tkxs/USA0Box/releases/latest)

## Quick Start

### For End Users
1. Download the appropriate installer for your platform from the [releases page](https://github.com/tkxs/USA0Box/releases)
2. Install and launch ZeroBox
...
-   **Cross-Platform Desktop**  
    :computer: ZeroBox is ready for Windows, Mac, and Linux users.
...
We welcome contributions from the community! Here's how you can help make ZeroBox better:

### 🐛 Reporting Issues
- Use [GitHub Issues](https://github.com/tkxs/USA0Box/issues) to report bugs or request features
...
### 🌍 Translations
Help make ZeroBox accessible to more people by contributing translations:
...
- Share ZeroBox with others
- Answer questions in [GitHub Discussions](https://github.com/tkxs/USA0Box/discussions)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/tkxs/USA0Box.git
   cd chatbox
   ```
...
[![Star History Chart](https://api.star-history.com/svg?repos=tkxs/USA0Box&type=Date)](https://star-history.com/#tkxs/USA0Box&Date)

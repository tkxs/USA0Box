...
export const ProviderSettingsSchema = z.object({
  ...
  sub2apiKeyId: z.number().int().positive().optional().catch(undefined),
  sub2apiGroupId: z.number().int().positive().optional().catch(undefined),
  sub2apiGroupPlatform: z.enum(['anthropic', 'openai', 'gemini', 'antigravity', 'grok']).optional().catch(undefined),
